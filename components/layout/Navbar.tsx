...
import { Factory, ShieldCheck, Github } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          ...
          <div className="flex items-center bg-slate-100 dark:bg-slate-800 p-1 rounded-lg border border-slate-200 dark:border-slate-700 text-xs">
            <span className="px-2 text-slate-500 font-medium hidden md:inline">Persona:</span>
            <select
              value={selectedUser}
            ...
            >
              ...
              <option value="vendor1">PrecisionTech (Vendor - CNC)</option>
              <option value="vendor2">Titan Forge (Vendor - Fabrication)</option>
            </select>
          </div>

          {/* UI Color & Theme Customizer */}
          <ThemeCustomizer />

          {/* Org Status Badge */}
          <div className="hidden lg:flex items-center space-x-1.5 px-2.5 py-1 bg-blue-50 dark:bg-blue-950/50 text-blue-700 dark:text-blue-300 rounded-md text-xs font-medium border border-blue-200 dark:border-blue-900">
          ...
          {/* GitHub Repository */}
          <a
            href="https://github.com/sagarw0/Manufacturing_World"
            target="_blank"
            rel="noreferrer"
            ...
            title="GitHub: sagarw0/Manufacturing_World"
          >
            <Github className="w-4 h-4" />
            <span className="hidden xl:inline">sagarw0</span>
          </a>
        </div>
      </div>
    </header>
